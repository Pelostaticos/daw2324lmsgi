...
Tarea 4
Centros educativos
Definir la estructura y reglas de validación de un vocabulario XML.
DTD, XML Schema (XSD)
UT05
Tarea 5
Sucesos
Transformar documentos XML a HTML para su presentación.
XSLT, XPath
UT06
Tarea 6
Consultas a una base de datos xml. Aeropuertos.
Consultar y extraer datos de documentos XML.
XQuery, XPath
