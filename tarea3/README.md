...
Unidad de Trabajo: UT03. Aplicaciones de los lenguajes de marcas a la sindicación de contenidos.
...
Los principales resultados de aprendizaje trabajados en esta tarea son:
    • RA3: Aplicar lenguajes de marcas para la distribución de contenidos, analizando las técnicas de sindicación y las herramientas.
    • Creación de Canales: Diseñar y construir canales de sindicación de contenidos (feeds) tanto en formato RSS como Atom.
    • Validación: Utilizar herramientas específicas para la validación de los ficheros generados, asegurando su correcto consumo por agregadores.
    • Análisis Conceptual: Identificar las ventajas de la sindicación en la gestión y transmisión eficiente de la información web.
...
Conceptos Clave
A
Desarrollo de la estructura básica del fichero RSS 2.0.
XML, Etiquetas RSS (<channel>, <item>, etc.)
B
Desarrollo de la estructura básica del fichero Atom 1.0.
XML, Etiquetas Atom (<feed>, <entry>, etc.)
C
Validación de los ficheros RSS y Atom mediante una herramienta de validación (por ejemplo, el Validador de Feed de W3C o WDG).
Validación de Estándares.

Referencia al archivo de sindicación (feed.xml o similar) en la cabecera (<head>) de la página web principal.
Descubrimiento Automático del Feed.
